...
public class EscapeSequences {
    ...
    public static final String SET_TEXT_COLOR_LIGHT_PURPLE = SET_TEXT_COLOR + "183m";
    public static final String SET_TEXT_COLOR_LIGHT_GREEN = SET_TEXT_COLOR + "108m";
    ...
    public static final String SET_BG_COLOR_LIGHT_PURPLE = SET_BG_COLOR + "183m";
    public static final String SET_BG_COLOR_LIGHT_GREEN = SET_BG_COLOR + "108m";
